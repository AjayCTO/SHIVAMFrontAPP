...
app.controller('checkOutController', ['$scope', '$rootScope', '$location', '$route', 'localStorageService', 'authService', function ($scope, $rootScope, $location, $route,localStorageService, authService) {
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.success == true) {
                    debugger;
                    //$scope.InvoiceDetailsEmail(allDataToSend);
    ...
    $scope.InvoiceDetailsEmail = function (allDataToSend) {
        debugger;
        $.ajax({
            url: serviceBase + 'api/CustomerOrders/InvoiceSend',
            type: 'POST',
            data: allDataToSend,
            dataType: 'json',
            success: function (data) {
                if (data.success == true) {
                    ...
                    alert("successfully send email to customer thier Invoice details");
                }
                $scope.$apply();
            }
        });
